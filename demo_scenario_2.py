...
failuresim = world.start('CSV', sim_start=START, datafile='data/failure_events.csv', continuous=False)
...
world.connect(failure, nodes_gen[1], ('attr1', 'in_service'))
